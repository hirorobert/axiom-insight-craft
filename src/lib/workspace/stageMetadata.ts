...
export const STAGE_CONFIGS: Record<WorkspaceMission, StageConfig> = {
  prepare: {
    ...
    tabLabel:    "PREPARE",
    shortLabel:  "PREP",
    description: "Import the trial balance, map accounts and verify the data",
    icon:        ShieldCheck,
    sequence:    1,
  },
  reconcile: {
    ...
    tabLabel:    "RECONCILE",
    shortLabel:  "RECON",
    description: "Reconcile source data and review adjusting journals",
    icon:        GitCompare,
    sequence:    2,
  },
  statements: {
  ...
  compliance: {
    ...
    tabLabel:    "COMPLIANCE",
    shortLabel:  "COMPLY",
    description: "Audit readiness, client summaries and evidence packages",
    icon:        ClipboardCheck,
    sequence:    5,
  },
  filing: {
    ...
    tabLabel:    "OUTPUTS",
    shortLabel:  "OUTPUT",
    description: "Assemble disclosure notes, management letter and filing-readiness material",
    icon:        FileText,
    sequence:    6,
  },
  monitor: {
