...
export const ENQUIRY_FORM_COPY = {
  ...
  challengeBackupRunning: "Running a backup security check for this browser…",
  challengeBackupReady: "Security check complete. You can send your enquiry.",
  challengeBackupFailed: "The security check could not be completed. Please check your connection and try again.",
