-- Applies authorized migration 20260925130000_solo_plan_no_free_plan_and_plan_feature_matrix.sql
...
DO $pr34$
DECLARE
  v_name TEXT := '20260925130000_solo_plan_no_free_plan_and_plan_feature_matrix.sql';
  v_expected TEXT := 'f0fb1b2b665a7562f761a2493faebc7f452f1df38844f5bdd49f8f45c6ef2fa1';
  v_body TEXT;
  v_sha  TEXT;
BEGIN
