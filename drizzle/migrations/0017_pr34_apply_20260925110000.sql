-- Applies authorized migration 20260925110000_named_user_billing_suspension_and_invitation_lifecycle.sql
...
DO $pr34$
DECLARE
  v_name TEXT := '20260925110000_named_user_billing_suspension_and_invitation_lifecycle.sql';
  v_expected TEXT := 'e2acec5154d7f9f71011a88033fa18fdfb6130089eb1845c42efe44c96fca8fa';
  v_body TEXT;
  v_sha  TEXT;
BEGIN
