...
-- ============================================================
-- SMOKE TESTS — relocated out of this executable migration file.
-- Negative-test invariants (must-fail V2 trigger checks, gate-lift
-- verification, historical-row closure, active-row uniqueness) are
-- now captured as static, non-executing assertions in
