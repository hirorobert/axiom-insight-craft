...
-- DROP FUNCTION IF EXISTS public.get_effective_non_reporting_status(UUID, JSONB);
-- DROP FUNCTION IF EXISTS public.resolve_account_review_batch(UUID, UUID, UUID, JSONB);
-- DROP TRIGGER IF EXISTS trg_ard_immutable ON public.account_review_decisions;
-- DROP FUNCTION IF EXISTS public.account_review_decisions_immutable();
-- DROP TABLE IF EXISTS public.account_review_decisions CASCADE;
-- DROP TABLE IF EXISTS public.account_review_batches CASCADE;
-- DROP SEQUENCE IF EXISTS public.account_review_decisions_seq;
